  ...
  return (
    <div className="issue-relation-sidebar">
      ...
      <div className="issue-relation-group is-blocks">
        <header><span><BlockingRelationIcon type="blocks" size={14} />阻塞了</span><span>{task.blocks.length}</span></header>
        <div className="issue-sub-issue-list">
          ...
          {task.blocks.length === 0 && <p className="issue-relation-empty">没有后继任务。</p>}
        </div>
      </div>
    </div>
  );
